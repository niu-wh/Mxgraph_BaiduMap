...
public class SchemaEditorMenuBar extends JMenuBar
{
	...
	public SchemaEditorMenuBar(final BasicGraphEditor editor)
	{
		...
		// Creates the OpenMap menu
		menu = add(new JMenu(mxResources.get("map")));

		item = menu.add(new JMenuItem(mxResources.get("index")));
	...
	// Creates the OpenMap menu
		...
		menu.add(editor
						.bind(
								mxResources.get("firstmap"),
								new FirstMapAction(
										"/com/mxgraph/examples/swing/resources/index.html")));

		menu.addSeparator();
		menu.add(editor
				.bind(
						mxResources.get("secondmap"),
						new SecondMapAction(
								"/com/mxgraph/examples/swing/resources/second.html")));
...
*/
	...
	/*	// Creates the Run menu
		...
		menu.add(editor.bind(mxResources.get("start"), new StartAction(),
				//"/com/mxgraph/examples/swing/images/start.gif"));
		menu.addSeparator();
		menu.add(editor.bind(mxResources.get("stop"), new StopAction(),
				//"/com/mxgraph/examples/swing/images/stop.gif"));
	...
	/*// Creates the OpenMap menu
		...
		item = menu.add(new JMenuItem(mxResources.get("firstlayer")));
		item.addActionListener(new ActionListener()
		{
			public void actionPerformed(ActionEvent e)
			{
