...
/**
 * Keeps the graph container in sync with the persistent graph state同步
 */
...
(function()
{
	...
	mxGraphView.prototype.validateBackgroundStyles = function()
	{
		...
		var canvas = graph.view.canvas;   //画布
		...
		if (graph.view.backgroundPageShape != null)
		{
			...
			//graph.container.openLink(RESOURCES_PATH + '/help' + ext + '.html');
		}
		else
		{
		...
		//canvas.openLink('http://localhost:8080/javascript/examples/grapheditor/www/resources/help.html')
	};
