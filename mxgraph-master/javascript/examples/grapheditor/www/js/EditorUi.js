...
/**
 * Creates the required containers.创建容器
 */
EditorUi.prototype.createDivs = function()
{
	...
	this.diagramContainer = this.createDiv('geDiagramContainer');    //中间部分图的容器
	...
	this.diagramContainer.style.right = ((this.format != null) ? this.formatWidth : 0) + 'px';//图的位置
